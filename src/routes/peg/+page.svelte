...
<div class="mx-auto flex justify-center items-center h-full">
    <Section customClass="w-[650px]">
        <div class="flex gap-6 mb-4">
            {#each tab as tab}
                <button class="flex gap-2 p-1 text-[#aee] {tabActive === tab?'text-opacity-100':'text-opacity-20'}" on:click={(()=>{
                    istabActive(tab)
                })}>
        ...
        {#if tabActive === 'PSM'}
             <div>
                <div class="flex gap-4 justify-between">
                    ...
                    <button class="bg-gray-700 rounded-full h-fit my-auto text-[#aee]">
                        <div class="w-4 h-4">
